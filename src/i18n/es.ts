export const es = {
    ...
    // Boot (comprobando el acceso guardado)
    boot_connecting: "Conectando con el proveedor…",
    boot_slow: "Está tardando más de lo normal.",
    boot_back_hint: "Pulsa Volver para cancelar",
